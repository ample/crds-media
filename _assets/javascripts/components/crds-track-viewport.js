...
//
//
/* harmony default export */ var crds_track_viewportvue_type_script_lang_js_shadow = ({
  ...
  methods: {
    checkPosition: function checkPosition() {
      ...
      if (rect.top <= (window.innerHeight || document.documentElement.clientHeight) && rect.left <= (window.innerWidth || document.documentElement.clientWidth) && rect.bottom >= 0 && rect.right >= 0) {
        this.beginCount();
      } else {
        this.stopCount();
      }
...
var component = normalizeComponent(
  components_crds_track_viewportvue_type_script_lang_js_shadow,
  render,
  staticRenderFns,
  false,
  null,
...
component.options.__file = "crds-track-viewport.vue"
/* harmony default export */ var crds_track_viewportshadow = (component.exports);
...
window.customElements.define('crds-track-viewport', vue_wc_wrapper(external_Vue_default.a, crds_track_viewportshadow))
...
/******/ });
//# sourceMappingURL=crds-track-viewport.js.map