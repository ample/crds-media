module.exports = function (migration) {
  ...
  article.createField('author').name('Author').type('Link').linkType('Entry').required(true);
  article.createField('category').name('Category').type('Link').linkType('Entry').required(true);
};